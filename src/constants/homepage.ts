...
export const STYLES = {
  ...
  text: {
    title: "text-zinc-800 text-6xl font-bold leading-[80px] font-['Pretendard_Variable'] text-center max-w-[1044px]",
    subtitle: "text-gray-700 text-xl font-medium leading-loose font-['Pretendard_Variable'] text-center max-w-[1044px]",
    button: "text-xl font-semibold leading-loose font-['Pretendard_Variable']",
    tableHeader: "text-xs font-medium font-['Pretendard_Variable'] text-gray-700",
  ...
  button: {
    ...
    primary: 'bg-gradient-to-b from-blue-700 to-indigo-400 text-white hover:from-blue-800 hover:to-indigo-700',
    secondary: 'bg-white border-2 border-blue-600 text-blue-600 hover:bg-blue-50',
    error: 'h-10 px-4 py-3 bg-blue-400 rounded-lg hover:bg-blue-500 transition-colors',
  },
} as const;
